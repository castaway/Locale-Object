=head1 Schema documentation for the Locale::Object database
...
* Nationmaster - L<http://www.nationmaster.com/>

* Ethnologue - L<http://www.ethnologue.com/>

* Wikipedia - L<http://en.wikipedia.org/>
...
* C<country_code> contains ISO 3166 two-letter country codes.

* C<timezone> contains time zone names as defined in the Olson database. See L<http://www.twinsun.com/tz/tz-link.htm> for more than you ever wanted to know about this.

* C<is_default> contains a boolean value indicating whether the time zone in question is default in the country. For countries with more than one time zone, a value of 'true' indicates the time zone covers the nation's capital.
